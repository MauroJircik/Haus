...
ADD COLUMN nome_remetente varchar(100);
UPDATE MENSAGEM set nome_remetente = 'Bruce Wayne' where id_remetente = 1;

SELECT mensagem.id_remetente, mensagem.nome_remetente, mensagem.mensagem, mensagem.data_mensagem, mensagem.id_receptor, usuario.nome as nome_receptor
FROM MENSAGEM inner join usuario
on mensagem.id_receptor = usuario.id_usuario
